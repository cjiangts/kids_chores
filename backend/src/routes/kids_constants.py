...
DRILL_SPEED_CUTOFF_MS_BY_CATEGORY_FIELD = 'drillSpeedCutoffMsByCategory'
MIN_DRILL_SPEED_CUTOFF_MS = 500
MAX_DRILL_SPEED_CUTOFF_MS = 30000
...
# EMA over per-attempt correct response time. Half-life ~10 attempts -> alpha ~0.067.
PRACTICE_PRIORITY_CORRECT_TIME_EMA_ALPHA = 0.067
...
KID_DECK_CATEGORY_OPT_IN_COL_DRILL_SPEED_CUTOFF_MS = 'drill_speed_cutoff_ms'
DEFAULT_DRILL_SPEED_CUTOFF_MS = 3000

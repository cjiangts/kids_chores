...
const ICON_PATHS = {
    ...
    'volume-2': '<path d="M11 5 6 9H2v6h4l5 4z"/><path d="M16 9a5 5 0 0 1 0 6"/><path d="M19.364 18.364a9 9 0 0 0 0-12.728"/>',
    'arrow-right': '<path d="M5 12h14"/><path d="m12 5 7 7-7 7"/>',
    flag: '<path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" x2="4" y1="22" y2="15"/>',
    crown: '<path d="M4.4 9.2c-.18-.7.62-1.23 1.18-.77l3.15 2.6 2.57-5.34c.28-.59 1.12-.59 1.4 0l2.57 5.34 3.15-2.6c.56-.46 1.36.07 1.18.77l-1.9 7.52a1.5 1.5 0 0 1-1.46 1.14H7.76a1.5 1.5 0 0 1-1.46-1.14Z"/><path d="M6.7 19.4h10.6c.44 0 .8.36.8.8s-.36.8-.8.8H6.7c-.44 0-.8-.36-.8-.8s.36-.8.8-.8Z"/>',
    ...
    help: '<path d="M8 7a4 4 0 0 1 8 1c0 3-4 4-4 4"/><path d="M12 19h.01"/>',
    ...
    'folder-plus': '<path d="M12 10v6"/><path d="M9 13h6"/><path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>',
    'copy-plus': '<path d="M15 12h-5"/><path d="M12.5 9.5v5"/><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',
    ...
    'user-form': '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
    'user-plus': '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/>',
    'credit-card': '<rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/>',
    smartphone: '<rect width="14" height="20" x="5" y="2" rx="2" ry="2"/><path d="M12 18h.01"/>',
    monitor: '<rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/>',
    'shield-check': '<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',
    gift: '<rect x="3" y="8" width="18" height="4" rx="1"/><rect x="5" y="12" width="14" height="9" rx="1"/><path d="M12 8v13"/><path d="M12 8s-1.8-4-4-4a2 2 0 0 0 0 4"/><path d="M12 8s1.8-4 4-4a2 2 0 0 1 0 4"/>',
    ...
    'moon': '<path d="M20.8 14.7A9 9 0 1 1 9.3 3.2 7 7 0 0 0 20.8 14.7Z"/>',
